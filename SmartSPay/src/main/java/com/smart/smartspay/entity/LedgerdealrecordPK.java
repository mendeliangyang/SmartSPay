 ...
 */
@Embeddable
public class LedgerdealrecordPK implements Serializable {
    ...
    public LedgerdealrecordPK() {
    }

    public LedgerdealrecordPK(String ledgerId, long dealSeq) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LedgerdealrecordPK)) {
            return false;
        }
        LedgerdealrecordPK other = (LedgerdealrecordPK) object;
    ...
    public String toString() {
        return "com.smart.smartspay.entity.LedgerdealrecordPK[ ledgerId=" + ledgerId + ", dealSeq=" + dealSeq + " ]";
    }
