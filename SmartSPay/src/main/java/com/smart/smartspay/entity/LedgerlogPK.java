 ...
 */
@Embeddable
public class LedgerlogPK implements Serializable {
    ...
    public LedgerlogPK(String ledgerId, long dealSeq) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LedgerlogPK)) {
            return false;
        }
        LedgerlogPK other = (LedgerlogPK) object;
    ...
    public String toString() {
        return "com.smart.smartspay.entity.LedgerlogPK[ ledgerId=" + ledgerId + ", dealSeq=" + dealSeq + " ]";
    }
