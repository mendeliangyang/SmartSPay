...
import com.smart.smartspay.util.alipay.utilHttpClient.HttpProtocolHandler;
import com.smart.smartspay.util.alipay.utilHttpClient.HttpRequest;
import com.smart.smartspay.util.alipay.utilHttpClient.HttpResponse;
import com.smart.smartspay.util.alipay.utilHttpClient.HttpResultType;
import com.smart.smartspay.util.alipay.sign.MD5;
...
public class AlipaySubmit {
    ...
    public static final String ALIPAY_GATEWAY_CHARSET = String.format("https://mapi.alipay.com/gateway.do?_input_charset=%s", AlipayConfig.input_charset);
